...
#include "../../../_tempate_code/QtControls/mycoolbar.h"
...
void myCoolBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (myCoolBar::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myCoolBar::valueChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject myCoolBar::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_myCoolBar.data,
    qt_meta_data_myCoolBar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
