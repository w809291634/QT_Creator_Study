...
#include "../../../_tempate_code/QtControls/myflashlist.h"
...
void myFlashList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (myFlashList::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myFlashList::sig_setCurrentIndex)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (myFlashList::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myFlashList::sig_itemClicked)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject myFlashList::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_myFlashList.data,
    qt_meta_data_myFlashList,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void PYFlashListPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PYFlashListPrivate::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PYFlashListPrivate::sig_setMaximum)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (PYFlashListPrivate::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PYFlashListPrivate::sig_setCurrentIndex)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (PYFlashListPrivate::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PYFlashListPrivate::sig_itemClicked)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject PYFlashListPrivate::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_PYFlashListPrivate.data,
    qt_meta_data_PYFlashListPrivate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
