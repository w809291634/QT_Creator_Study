    ...
    if(!IC_Mode)        //基础
    {
        ...
        else if(IC_Data.mid(0,11) == "CD DC 00 81")
        {
            ...
            case 2:
                ...
                ui->IC_listWidget_Sys_Data->addItem("("+QString::number(IC_Data.mid(16,2).toInt(0,16),10)+
                                                    ","+QString::number(IC_Data.mid(19,2).toInt(0,16),10)+
                                                    ") "+IC_Data.mid(21,47));
...
/**
* @funcname      ETC_DataHandle
* @brief         900M数据处理函数
* @param         data-900M模式串口接收到的数据
* @return        无
* @author        Zhoucj
* @date          2018-08-27
***************************************************************/
