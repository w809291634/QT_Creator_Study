...
#include "../../../_tempate_code/QtControls/mybattery.h"
...
void myBattery::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (myBattery::*)(qreal );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myBattery::valueChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject myBattery::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_myBattery.data,
    qt_meta_data_myBattery,
    qt_static_metacall,
    nullptr,
    nullptr
} };
