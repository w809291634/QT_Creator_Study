...
#include "../../../_tempate_code/QtControls/myphotoview.h"
...
QT_INIT_METAOBJECT const QMetaObject PYNum::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_PYNum.data,
    qt_meta_data_PYNum,
    qt_static_metacall,
    nullptr,
    nullptr
...
void myPhotoView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (myPhotoView::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myPhotoView::sig_setValue)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (myPhotoView::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myPhotoView::sig_setTotal)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject myPhotoView::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_myPhotoView.data,
    qt_meta_data_myPhotoView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
