...
#include "../../../_tempate_code/QtControls/mybuttonboard.h"
...
void PYButtonBoardPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (PYButtonBoardPrivate::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PYButtonBoardPrivate::sig_ButtonClicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject PYButtonBoardPrivate::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_PYButtonBoardPrivate.data,
    qt_meta_data_PYButtonBoardPrivate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void myButtonBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (myButtonBoard::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myButtonBoard::sig_ButtonClicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject myButtonBoard::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_myButtonBoard.data,
    qt_meta_data_myButtonBoard,
    qt_static_metacall,
    nullptr,
    nullptr
} };
