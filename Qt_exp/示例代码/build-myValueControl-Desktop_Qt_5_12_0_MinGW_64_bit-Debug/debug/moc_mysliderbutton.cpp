...
#include "../../../_tempate_code/QtControls/mysliderbutton.h"
...
void mySliderButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (mySliderButton::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mySliderButton::sig_itemClicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject mySliderButton::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_mySliderButton.data,
    qt_meta_data_mySliderButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
