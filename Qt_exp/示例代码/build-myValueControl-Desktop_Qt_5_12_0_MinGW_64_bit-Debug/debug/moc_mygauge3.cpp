...
#include "../../../_tempate_code/QtControls/mygauge3.h"
...
void myGauge3::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (myGauge3::*)(qreal );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myGauge3::valueChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject myGauge3::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_myGauge3.data,
    qt_meta_data_myGauge3,
    qt_static_metacall,
    nullptr,
    nullptr
} };
